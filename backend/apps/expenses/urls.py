...
urlpatterns = [
    ...
    path('breakdown/', views.ExpenseBreakdownByVehicleMonthView.as_view(), name='expense-breakdown'),
    ...
    path('fastag/<uuid:pk>/detail/', views.FastagDetailView.as_view(), name='fastag-breakdown-detail'),
